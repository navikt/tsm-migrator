...
val sykmeldingUpdateService = module {
    single {
        ...
        val consumer = KafkaConsumer(Properties().apply {
            ...
            this[ConsumerConfig.GROUP_ID_CONFIG] = "sykmelding-reformat-update-consumer"
            this[ConsumerConfig.CLIENT_ID_CONFIG] = "${env.hostname}-sykmelding-reformat-update-consumer"
        ...
        val producer = KafkaProducer<String, SykmeldingRecord>(Properties().apply {
            ...
            this[ProducerConfig.CLIENT_ID_CONFIG] = "${env.hostname}-sykmelding-reformat-update-producer"
        ...
        val updateService = SykmeldingUpdateService(
